#Happy Playlist
happy_songs = [Song.create(name: "Walking On Sunshine", artist: "Katrina & The Waves"),
...
drake_playlist = Playlist.create(name:"Drake", mood:"Drake")

drake_songs.each do |song| 
    song_playlist.create(playlist_id: drake_playlist.id, song_id: song.id)
end
